...
public class RPHashAdaptiveStream implements StreamClusterer {
	...
	public RPHashAdaptiveStream(int k, GenerateStreamData gen, int i) {
	...
	public static void main(String[] args) throws Exception {
		...
		StreamClusterer rphit = new RPHashAdaptiveStream(k, gen, 1);
