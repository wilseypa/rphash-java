 ...
 * @param <E>
 */
public class CountMinSketchAlt<E> implements ISimpleFrequency<E> {
    ...
    @Override
    public boolean add(E item) throws FrequencyException {
        add(item, 1);
        return true;
    }

    @Override
    public boolean add(E item, long count) throws FrequencyException {
        if (count < 0) {
